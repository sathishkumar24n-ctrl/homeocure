...
function Consent() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center gap-6 p-8">
      <div>
        <h1 className="text-2xl font-semibold">Connect {clientName} to HomeoCare</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          This will let <strong>{clientName}</strong> access HomeoCare as you — including your
          patients, appointments, follow-ups, and remedy inventory scoped to your clinic.
        </p>
      </div>
      {error ? (
